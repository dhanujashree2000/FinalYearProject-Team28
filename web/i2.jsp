...
-->
   ...
   msg=(String)request.getAttribute("msg");
    ...
    %>
          <table width="828" border="0" align="center" bgcolor="#FFFFFF">
            ...
            <tr>
              <td height="471"><table width="482" border="0" align="center">
                <tr>
                    <td width="476" height="40" align="center"><span class="style4"><strong>Login Form </strong></span></td>
                </tr>
                <tr>
		 ...
		 <tr>
                      <td width="177" height="35"><strong>USERNAME </strong></td>
                      <td width="10">&nbsp;</td>
                      <td width="232"><label>
